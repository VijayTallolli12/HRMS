...
class UpdateReportingHierarchyRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('update-reporting-hierarchy');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'reporting_type' => 'required|in:direct,indirect,functional,administrative',
    ...
    public function messages(): array
    {
        return [
            ...
            'reporting_type.in' => 'Reporting type must be direct, indirect, functional, or administrative.',
