<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Employment Status</h2>
    </x-slot>
    <div class="py-12">
                ...
                <form action="{{ route('employment-statuses.store') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <x-primary-button type="submit">Create Employment Status</x-primary-button>
                        </div>
                    </div>
                </form>
            </div>
