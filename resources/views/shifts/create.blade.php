<x-app-layout>
    <x-page-header title="Create Shift" description="Define a new work shift schedule." icon="clock">
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="start_time" name="start_time" type="time" class="input-field" value="{{ old('start_time') }}" required />
                            <x-input-error :messages="$errors->get('start_time')" class="mt-2" />
                        </div>
                        <div>
                            <label for="end_time" class="label">End Time <span class="text-red-500">*</span></label>
                            <input id="end_time" name="end_time" type="time" class="input-field" value="{{ old('end_time') }}" required />
                    ...
                    <div class="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-gray-100">
                        ...
                        <x-primary-button type="submit">Create Shift</x-primary-button>
                    </div>
                </div>
            </form>
        </div>
