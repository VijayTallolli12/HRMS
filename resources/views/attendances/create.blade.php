                ...
                <form action="{{ route('attendances.store') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="clock_in" name="clock_in" type="time" class="mt-1 block w-full" :value="old('clock_in')" required />
                            <x-input-error :messages="$errors->get('clock_in')" class="mt-2" />
                        </div>
                        <div>
                            <x-input-label for="clock_out" value="Clock Out" />
                            <x-text-input id="clock_out" name="clock_out" type="time" class="mt-1 block w-full" :value="old('clock_out')" />
                        ...
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('attendances.index') }}" class="text-gray-600 hover:text-gray-900" wire:navigate>Cancel</a>
