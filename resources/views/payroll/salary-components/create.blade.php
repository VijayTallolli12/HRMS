<x-app-layout>
    <x-page-header title="Create Salary Component" icon="heroicon-o-cube">
        ...
        <form action="{{ route('payroll.salary-components.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <x-text-input id="default_value" name="default_value" type="number" step="0.01" class="mt-1 block w-full" :value="old('default_value', '0.00')" required />
                    @error('default_value')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-gray-100">
                ...
                <x-primary-button type="submit">Create Component</x-primary-button>
            </div>
        </form>
    </div>
</x-app-layout>
