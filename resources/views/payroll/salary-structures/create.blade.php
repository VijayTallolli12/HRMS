<x-app-layout>
    <x-slot name="header">
        <x-page-header
            ...
            icon="calculator"
            description="Define a new salary structure for an employee."
        >
                    ...
                    <div class="space-y-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <x-text-input id="basic_salary" name="basic_salary" type="number" step="0.01" class="mt-1.5 block w-full" :value="old('basic_salary')" required />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <x-text-input id="effective_from" name="effective_from" type="date" class="mt-1.5 block w-full" :value="old('effective_from')" required />
                                <x-input-error :messages="$errors->get('effective_from')" class="mt-1.5" />
                            </div>
                            <div>
                                <x-input-label for="effective_to" value="Effective To" />
                                <x-text-input id="effective_to" name="effective_to" type="date" class="mt-1.5 block w-full" :value="old('effective_to')" />
