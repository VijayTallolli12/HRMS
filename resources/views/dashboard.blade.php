<x-app-layout>
    ...
    @php
        $stats = [
            ...
            'pending_leaves' => class_exists(\App\Models\Leave::class) ? \App\Models\Leave::where('status', 'pending')->count() : 0,
        ];
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($recentEmployees as $emp)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $emp->join_date ?? '-' }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
