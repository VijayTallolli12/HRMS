<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Leave</h2>
    </x-slot>
    <div class="py-12">
                ...
                <form action="{{ route('leaves.store') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="days" name="days" type="number" class="mt-1 block w-full" :value="old('days')" min="1" required />
                        ...
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('leaves.index') }}" class="text-gray-600 hover:text-gray-900" wire:navigate>Cancel</a>
